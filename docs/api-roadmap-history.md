# Historique de la roadmap API

Archive de la checklist API detaillee jusqu'au 10 aout 2026.

Ce document conserve les travaux termines, les validations historiques et les
anciens perimetres. Il ne sert plus au pilotage courant. La checklist active vit
dans `api/todo.md`.
